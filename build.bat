...
REM 64-bit build
del *.pdb > NUL 2> NUL
cl %CommonCompilerFlags% W:\handmade\code\handmade.cpp -Fmhandmade.map /LD /link -incremental:no -opt:ref -PDB:handmade_%date:~-10,2%%date:~-7,4%%date:~-3,3%_%time:~0,2%%time:~3,2%%time:~6,2%.pdb /EXPORT:GameGetSoundSamples /EXPORT:GameUpdateAndRender
